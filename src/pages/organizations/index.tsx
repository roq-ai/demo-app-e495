...
export function OrganizationListPage(props: OrganizationListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getOrganizations({
        relations: ['user', 'error_log.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('error_log', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'error_log',
          header: 'Error Log',
          accessorKey: 'error_log',
          cell: ({ row: { original: record } }: any) => record?._count?.error_log,
        }
      : null,
