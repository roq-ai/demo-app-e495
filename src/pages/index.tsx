  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Demo App - Your reliable partner in error logging and management, ensuring seamless operations and optimal performance for your applications."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1601119479271-21ca92049c81?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxlcnJvciUyMGxvZ2dpbmd8ZW58MHx8fHwxNjk2MTg2NzA2fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Demo App - Your reliable partner in error logging and management, ensuring seamless operations and optimal performance for your applications.`}
            </Text>
            <Box
