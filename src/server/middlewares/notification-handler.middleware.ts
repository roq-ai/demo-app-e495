...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'Support Ticket Submission.create': {
    roles: ['owner', 'administrator', 'support-staff'],
    key: 'support_ticket_submission',
    tenantPath: [],
    userPath: [],
  },
  'Support Ticket Status Update.update': {
    roles: ['owner', 'administrator', 'support-staff'],
    key: 'support_ticket_status_update',
    tenantPath: [],
    userPath: [],
  },
...
const tenantRoles: string[] = ['owner', 'administrator', 'support-staff', 'end-user', 'developer'];
